 ...
 * @author josep
 */
@WebServlet(name = "Servlethijos", urlPatterns = {"/Servlethijos"})
public class Servlethijos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Servlethijos</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Servlethijos at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
// Verificación de existencia de idAsistencia en la solicitud
        ...
        RequestDispatcher objdevuelve = request.getRequestDispatcher("Datos Hijo.jsp");
