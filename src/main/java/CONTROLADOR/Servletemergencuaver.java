 ...
 * @author josep
 */
@WebServlet(name = "Servletemergencuaver", urlPatterns = {"/Servletemergencuaver"})
public class Servletemergencuaver extends HttpServlet {
...
ContactoEmergenciaDAO test;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Servletemergencuaver</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Servletemergencuaver at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    try {
        ...
        RequestDispatcher objdevuelve = request.getRequestDispatcher("cintactoreporte.jsp");
    ...
    try {
        ...
        RequestDispatcher objdevuelve = request.getRequestDispatcher("contactoreporte.jsp");
        objdevuelve.forward(request, response);
    }
