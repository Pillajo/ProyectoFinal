 ...
 * @author josep
 */
@WebServlet(name = "Servletverusuarios", urlPatterns = {"/Servletverusuarios"})
public class Servletverusuarios extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Servletverusuarios</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Servletverusuarios at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    try {
        ...
        RequestDispatcher objdevuelve = request.getRequestDispatcher("usuarioreporte.jsp");
