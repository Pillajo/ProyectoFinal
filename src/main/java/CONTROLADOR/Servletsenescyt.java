 ...
 * @author josep
 */
@WebServlet(name = "Servletsenescyt", urlPatterns = {"/Servletsenescyt"})
public class Servletsenescyt extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Servletsenescyt</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Servletsenescyt at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       // Verificación de existencia de idAsistencia en la solicitud
        ...
        RequestDispatcher objdevuelve = request.getRequestDispatcher("Situacion Senescyt.jsp");
