 ...
 * @author josep
 */
@WebServlet(name = "Servlettrayectoriaver", urlPatterns = {"/Servlettrayectoriaver"})
public class Servlettrayectoriaver extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Servlettrayectoriaver</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Servlettrayectoriaver at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    try {
        ...
        RequestDispatcher objdevuelve = request.getRequestDispatcher("trayectoriareporte.jsp");
