 ...
 * @author josep
 */
@WebServlet(name = "Servletsenescytver", urlPatterns = {"/Servletsenescytver"})
public class Servletsenescytver extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Servletsenescytver</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Servletsenescytver at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    try {
        ...
        RequestDispatcher objdevuelve = request.getRequestDispatcher("senescytreporte.jsp");
