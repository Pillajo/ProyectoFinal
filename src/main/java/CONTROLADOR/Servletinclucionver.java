 ...
 * @author josep
 */
@WebServlet(name = "Servletinclucionver", urlPatterns = {"/Servletinclucionver"})
public class Servletinclucionver extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Servletinclucionver</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Servletinclucionver at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    try {
        ...
        RequestDispatcher objdevuelve = request.getRequestDispatcher("inclucionreporte.jsp");
