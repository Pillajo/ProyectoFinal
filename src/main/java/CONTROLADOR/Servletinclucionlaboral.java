 ...
 * @author josep
 */
@WebServlet(name = "Servletinclucionlaboral", urlPatterns = {"/Servletinclucionlaboral"})
public class Servletinclucionlaboral extends HttpServlet {
  InclucionLaboralDAO test;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Servletinclucionlaboral</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Servletinclucionlaboral at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    int idInclucionLaboral;
       ...
       // Verificación de existencia de idAsistencia en la solicitud
        ...
        RequestDispatcher objdevuelve = request.getRequestDispatcher("Inclucion Laboral.jsp");
