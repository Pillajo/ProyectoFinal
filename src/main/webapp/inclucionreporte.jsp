<%-- 
    Document   : inclucionreporte
    Created on : 01/02/2024, 9:26:56
    Author     : josep
--%>
...
<html>
    ...
    <body>
        <h1 class="text-center mb-5">Inclución Laboral</h1>  
        <div class="container mt-4">
            <form action="Servletinclucionver" method="post">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <a href="Inclucion Laboral.jsp" class="btn btn-warning btn-sm">EDITAR TODO</a>
                            <a href="Inclucion Laboral.jsp" class="btn btn-danger btn-sm">Salir</a> 
                        </div>
                    </div>
                    <div class="col-md-6">
        ...
        <div class="col-sm-18">
            <table class="table table-hover">
                ...
                <script>
                    function redirectToInclucionLaboral(id) {
                        window.location.href = "Inclucion Laboral.jsp?id=" + id;
                    }
                </script>
        </div>
    </div>
