<%-- 
    Document   : hijoreporte
    Created on : 01/02/2024, 8:57:24
    Author     : josep
--%>
...
<html>
    ...
    <body>
        <h1 class="text-center mb-5">Datos del Hijo</h1>   
        <div class="container mt-4">
            <form action="Servlethijover" method="post">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <a href="Datos Hijo.jsp" class="btn btn-warning btn-sm">EDITAR TODO</a>
                            <a href="Datos Hijo.jsp" class="btn btn-danger btn-sm">Salir</a> 
                        </div>
                    </div>
                    <div class="col-md-6">
        ...
        <div class="col-sm-18">
            <table class="table table-hover">
                ...
                <script>
                    function redirectToDatosHijo(id) {
                        window.location.href = "Datos Hijo.jsp?id=" + id;
                    }
                </script>
        </div>
    </div>
